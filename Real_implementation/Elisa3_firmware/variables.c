...
/***************/
unsigned int ROBOTS = 3;
unsigned int id = 2;
float L[100] = {0};
float Bx[100] = {0};
float By[100] = {0};
float Xpos_array[100] = {0};
float Ypos_array[100] = {0};
float fixed_position[2] = {0};
float position[2] = {0};	
float u_test[2];
float lambda_2 = 0.585; //0.267
float K =0.1;
unsigned long int h = 20;
unsigned int trigger_count = 1;
unsigned int count_resets = 0;
int error_radius = 10;
float speed_temp = 0;
...
float xPos_fixed = 0.0, yPos_fixed = 0.0;
bool start_comm = false;

float offset_rwheel = 0;
float offset_lwheel = 0;
signed int l_speed=0, r_speed=0;
...
unsigned char irEnabled = 0;						// flag indicating whether the TV remote commands are interpreted or discarded
