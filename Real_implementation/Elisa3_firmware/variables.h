...
/*** Algorithms ***/
/***************/
extern unsigned int ROBOTS;
extern unsigned int id;
extern float L[100];
extern float Bx[100];
extern float By[100];
extern float Xpos_array[100];
extern float Ypos_array[100];
extern float fixed_position[2];
extern float position[2];
extern float u_test[2];
extern float lambda_2;
extern float K;
extern unsigned long int h;
extern float B[2][100];
extern float u_max;
extern unsigned int trigger_count;
extern unsigned int count_resets;
extern int error_radius;
extern float speed_temp;
extern float filtered_theta;

float angle_temp;
float speed;
bool reset_flag;

extern float xPos_fixed, yPos_fixed;
extern bool start_comm;
bool turn;

extern float offset_rwheel;
extern float offset_lwheel;
signed int l_speed, r_speed;

/***********/
/*** CLOCKS ***/
/***********/
extern unsigned long int loop_time;
extern unsigned long int init_time;
extern unsigned long int control_time;
extern unsigned long int comm_time;
