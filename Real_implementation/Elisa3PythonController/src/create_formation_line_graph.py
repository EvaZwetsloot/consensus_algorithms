...
G1 = nx.grid_2d_graph(2, 3)
# L = nx.laplacian_matrix(G).toarray()
pos = nx.spring_layout(G1, dim=2, scale=0.2, center=[0, 0])
pos = nx.circular_layout(G, 0.4, dim=2)
p_out = np.array(list(pos.values()))
#p_out = np.array([[-0.16, 0, 0.16, -0.08, 0.08, 0],[0,0,0, 0.12, 0.12, 0.25]]).T
